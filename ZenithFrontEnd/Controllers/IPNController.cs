...
namespace ZenithFrontEnd.Controllers
{
    public class IPNController : Controller
    {
        ...
        private void ProcessVerificationResponse(string verificationResponse)
        {
            if (verificationResponse.Equals("VERIFIED"))
            {
                ...
                Session["transactionID"] = transactionID.ToString() + payerEmail.ToString() + paymentStatus.ToString();
                Response.Redirect("http://cbpackaging.azurewebsites.net/CheckoutPages/CheckoutSuccess.aspx");
            }
            else if (verificationResponse.Equals("INVALID"))
            {
                //Log for manual investigation
                Session["transactionID"] = "it was Invalid x_x";
                Response.Redirect("http://cbpackaging.azurewebsites.net/CheckoutPages/CheckoutSuccess.aspx");
            }
            else
            {
