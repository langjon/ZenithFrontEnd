...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="bodyDiv">
        <asp:GridView  class="orderGrid" ID="CustomerGridView" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="CusID" DataSourceID="SqlDataSource1">
            <Columns>
